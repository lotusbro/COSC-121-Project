...
//(A)	
// By making Animal as abstract we have provided all the other classes that are extending to Animal
//to override methods and make them have a similarity between them.
	...
	// (B)
	// It provides as an template that others classes can utilize.
	...
	public int compareTo(Animal a) {
		if (getEnergy() > a.getEnergy()) {
			return 1;

		} else if (getEnergy() < a.getEnergy()) {
			return -1;
		} else {
			return 0;
		}
